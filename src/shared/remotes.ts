...
export const remotes = createRemotes(
    {
        ...
        avatar_option_selected : remote<Server,[action : "Attack",goal : Vector3] | [action : "Boulder",goal : Vector3] | [action : "Move",path : Direction[]]>(),
        pathfind : remote<Server,[ability : string]>().returns<PathTile[]>(),
        get_adjacencies : remote<Server,[]>().returns<[Vector3,[Part,Direction][]][]>(),
